...
for r in rows:
    ...
    if '品牌店' in shop and reason == '无匹配' and '扣底盒' in spec_name:
        pp_koudi_miss.append(r)
    else:
        remaining.append(r)

print(f"品牌店扣底盒无匹配: {len(pp_koudi_miss)}条", flush=True)
